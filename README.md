...
Description: 
A classic river-crossing puzzle where three missionaries and three cannibals must cross a river using a boat, following constraints to ensure no missionaries are eaten.
...
Description: 
A bike rental system designed using Object-Oriented Programming (OOPs) concepts, allowing users to rent bikes hourly, daily, or weekly.
...
Description: 
A simple contact management application to add, update, delete, and search contacts using Python.
